...
public class IrcApplication extends Application implements Observable {
	 ...
	 * know by construction that the advertised name will correspond to an IRC
     ...
     * related to hosting an IRC channel.  In a "real" application this kind
     ...
     * related to using a remotely hosted IRC channel.  In a "real" application
